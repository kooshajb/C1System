...
$(document).ready(function () {
	...
	if (e) {
		...
		t.setOption({
			...
			xAxis: [{
				type: "category",
				data: ["ژان", "فور", "مارس", "آور", "مه", "ژوئن", "ژول", "آگو", "سپت", "اوک", "نوا", "دسا"],
				axisTick: {
					alignWithLabel: !0
				},
				splitLine: {
	...
	if (i) {
		...
		r.setOption(_extends({}, echartOptions.lineFullWidth, {
			series: [_extends({
	...
	if (n) {
		...
		s.setOption(_extends({}, echartOptions.lineFullWidth, {
			series: [_extends({
	...
	if (l) {
		...
		c.setOption(_extends({}, echartOptions.lineNoAxis, {
			series: [{
