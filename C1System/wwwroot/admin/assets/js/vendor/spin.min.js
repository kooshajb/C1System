! function (t, i) {
	...
	function o(t, i) {
		var e, o, n = t.style;
		for (i = i.charAt(0).toUpperCase() + i.slice(1), o = 0; c.length > o; o++)
			if (void 0 !== n[e = c[o] + i]) return e;
	...
	a.defaults = {}, r(a.prototype, {
		...
		lines: function (o, r) {
			...
			for (var c, d = 0, p = (r.lines - 1) * (1 - r.direction) / 2; r.lines > d; d++) c = n(t(), {
				position: "absolute",
				top: 1 + ~(r.width / 2) + "px",
		...
		opacity: function (t, i, e) {
			t.childNodes.length > i && (t.childNodes[i].style.opacity = e)
		}
	});
	var f = n(t("group"), {
	...
	return !o(f, "transform") && f.adj ? function () {
		...
		p.addRule(".spin-vml", "behavior:url(#default#VML)"), a.prototype.lines = function (t, o) {
			...
			if (o.shadow)
				for (l = 1; o.lines >= l; l++) a(l, -2, "progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");
			for (l = 1; o.lines >= l; l++) a(l);
			return i(t, u)
		}, a.prototype.opacity = function (t, i, e, o) {
			var n = t.firstChild;
			o = o.shadow && o.lines || 0, n && n.childNodes.length > i + o && (n = (n = (n = n.childNodes[i + o]) && n.firstChild) && n.firstChild) && (n.opacity = e)
		}
	}() : l = o(f, "animation"), a
});
