...
namespace C1System.Data.CustomerSuccess
{
    ...
    public class CustomerSuccessRepository : ICustomerSuccessRepository
    {
        ...
        public async Task<GenericResponse<GetCustomerSuccessDto>> Add(AddUpdateCustomerSuccessDto dto)
        {
            ...
            Models.CustomerSuccess.CustomerSuccess entity = _mapper.Map<Models.CustomerSuccess.CustomerSuccess>(dto);

            EntityEntry<Models.CustomerSuccess.CustomerSuccess> i = await _context.Set<Models.CustomerSuccess.CustomerSuccess>().AddAsync(entity);
        ...
        public async Task<GenericResponse> Delete(Guid id)
        {
            ...
            _context.Set<Models.CustomerSuccess.CustomerSuccess>().Remove(_mapper.Map<Models.CustomerSuccess.CustomerSuccess>(i.Result));
            await _context.SaveChangesAsync();
        ...
        {
            IEnumerable<Models.CustomerSuccess.CustomerSuccess> i = await _context.Set<Models.CustomerSuccess.CustomerSuccess>().AsNoTracking().ToListAsync();
        ...
        {
            var i = _context.Set<Models.CustomerSuccess.CustomerSuccess>()
         ...
         i.ManagerName = dto.ManagerName;
            ...
            _context.Set<Models.CustomerSuccess.CustomerSuccess>().Update(i);
            await _context.SaveChangesAsync();
            return new GenericResponse<GetCustomerSuccessDto>(_mapper.Map<GetCustomerSuccessDto>(i));
        }
    }
