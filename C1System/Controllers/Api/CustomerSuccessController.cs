...
[ApiController]
public class CustomerSuccessController : ControllerBase
{
    ...
    public async Task<ActionResult> CreateCustomerSuccess([FromBody] AddUpdateCustomerSuccessDto dto)
    {
        ...
        return CreatedAtAction(nameof(GetCustomerSuccess), new { id = createdCustomerSuccess.Id }, createdCustomerSuccess.Result);
    }
