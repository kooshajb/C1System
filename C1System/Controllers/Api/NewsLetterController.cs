...
namespace C1System.Controllers.Api
{
    ...
    public class NewsLetterController : Controller
    {
        ...
        [HttpPost]
        public async Task<ActionResult> CreateNewsLetter([FromBody] AddNewsLetterDto dto)
        {
        ...
        [HttpPut("{id:guid}")]
        public async Task<ActionResult<GetNewsLetterDto>> UpdateNewsLetter([FromBody] UpdateNewsLetterDto dto, Guid id)
        {
